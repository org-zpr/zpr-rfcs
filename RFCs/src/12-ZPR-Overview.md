...
- version: 1
  ...
  - Delete \"network\" as example of actor type because it is a confusing special case. The definition remains true as stated because networks can be treated as devices.
  - Make a more precise distinction between an attribute and its name and explain type definition.
  - Describe ZPR endpoints.
  - Postpone explicit mention of the communications system that enables nodes to communicate. This should be in more precise descriptions, but not this overview.
  - Describe a private cloud as an example of a node.
  - Describe distinction between policy language and complied policy representation.
...
- version: 5
  ...
  - Clarify definition of identity.
  - Update Figure 1 to new vocabulary
